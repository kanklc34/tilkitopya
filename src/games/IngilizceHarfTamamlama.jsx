...
function generateLetterPad(correctLetter) {
  ...
  while (pool.size < 6) pool.add(ENGLISH_LETTERS[rand(0, ENGLISH_LETTERS.length - 1)]);
  ...
  return (
    <div className="word-root">
      ...
      <div className="top-row">
        <div className="brand"><img src={`${import.meta.env.BASE_URL}fox-mascot.png`} className="brand-emoji-img" alt="Tilki" /> Word Fill</div>
