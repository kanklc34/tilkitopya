...
function CardFace({ card }) {
  if (card.kind === "word") {
    return <span className="card-word">{card.value}</span>;
  }
  ...
  return (
    <div className="match-root">
      ...
      <div className="top-row">
        <div className="brand"><img src={`${import.meta.env.BASE_URL}fox-mascot.png`} className="brand-emoji-img" alt="Tilki" /> Word Match</div>
            ...
            >
              <div className="card-inner">
                <div className="card-face card-back">
                  <img src={`${import.meta.env.BASE_URL}fox-mascot.png`} className="card-back-icon-img" alt="Tilki" />
                </div>
        ...
        <div className="tutorial-overlay">
          ...
          <div className="tutorial-steps">
            <div className="tutorial-step">
              ...
              <span>İngilizce kelimeyi resmiyle eşleştir</span>
            </div>
            <div className="tutorial-step">
              <span className="tutorial-step-icon">👆</span>
