...
export default function NatureObserveGame({ onExit } = {}) {
  ...
  return (
    <div className="find-root">
      ...
      <div className="top-row">
        <div className="brand"><img src={`${import.meta.env.BASE_URL}fox-mascot.svg`} className="brand-emoji-img" alt="Tilki" /> Doğa Gözlemi</div>
